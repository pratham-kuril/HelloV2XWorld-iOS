...
class SDKConfigurator: NSObject, DIContainerProvider {
    ...
    func connectToSTEP() {
        ...
        let camPublicSubServiceGroup = MQTTSubServiceGroup(publish: ConstantMessagesParameters.CAM_PUBLISH_GROUP, subscribe: ConstantMessagesParameters.CAM_SUBSCRIBE_GROUP)
